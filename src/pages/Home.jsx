          ...
          <div className="row align-items-center g-4 ">
            ...
            <div className="col-12 col-lg-6">
              ...
              <p className="section-text mb-3">
                ...
                San Antonio competing in both Vex U and the Siemen’s Immersive
                Design Challenge.
              </p>
              <p className="section-text mb-3">
                This organization started Fall 2026, by a group of friends
                interested in Robotics.{" "}
              </p>
              <p className="section-text mb-3">
                Our goal is to provide a space where students interested in
                robotics, programming, or just exploring UTSA can come together
                and compete in competitions, participate in socials, and learn
                new skills.
              </p>
            </div>
          </div>
          ...
          <div className="row align-items-center g-4">
            <div className="col-12 col-lg-6">
              ...
              <p className="section-text">
                210 Robotics operates out of The University of Texas at San
                Antonio, where members collaborate on robot design, engineering,
                programming, and technical development through competitive
                robotics and hands-on projects.
              </p>
            </div>
